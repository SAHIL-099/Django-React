...
# class SoftTennis(models.Model):
#     name = models.CharField(max_length=100)
#     price = models.IntegerField()
#     description = models.TextField()
#     size=models.FloatField() #get by user selected size in form
#     weight=models.IntegerField() #get by user  selected  weight in form
#     width=models.FloatField()
#     def __str__(self):
#         return self.name
    
# class Season_Bat(models.Model):
#     name = models.CharField(max_length=100)
#     price = models.IntegerField()
#     description = models.TextField()
#     size=models.FloatField() #get by user selected size in form
